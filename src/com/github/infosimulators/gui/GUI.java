...
public class GUI extends PApplet {
	...
	/**
	 * Called once after startup Creates a main tab and makes it active
	 */
	public void setup() {
	...
	/**
	 * Called each frame Split into 3 phases, each one overlaying the previous
	 * ones.
	 */
	public void draw() {
	...
	private void displayTabs() {
		...
		for (int i = 0; i < tabs.size(); i++) {
			...
			fill(255);
			text(tabs.get(i).getHeader(), i * width / tabs.size() + 10, 10, (i + 1) * width / tabs.size() - 10,
					height / 20 - 10);
		}
	}
