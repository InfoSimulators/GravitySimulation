...
public class NumberField extends GElement{
	...
	private void keyPress(String k){
		...
		if(Integer.toString(value).length() < max){
			switch(k.charAt(0)){
			case '0' : value = Integer.parseInt(Integer.toString(value) + "0"); break;
			case '1' : value = Integer.parseInt(Integer.toString(value) + "1"); break;
			case '2' : value = Integer.parseInt(Integer.toString(value) + "2"); break;
			case '3' : value = Integer.parseInt(Integer.toString(value) + "3"); break;
			case '4' : value = Integer.parseInt(Integer.toString(value) + "4"); break;
			case '5' : value = Integer.parseInt(Integer.toString(value) + "5"); break;
			case '6' : value = Integer.parseInt(Integer.toString(value) + "6"); break;
			case '7' : value = Integer.parseInt(Integer.toString(value) + "7"); break;
			case '8' : value = Integer.parseInt(Integer.toString(value) + "8"); break;
			case '9' : value = Integer.parseInt(Integer.toString(value) + "9"); break;
			case PApplet.ENTER : setActive(false);
