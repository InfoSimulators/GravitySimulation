...
public class Vector2 {
	...
	*
	* @return A new {@link Vector2} based on the given parameters.
	*/
	public static Vector2 fromRadial(float theta, float length) {
		return new Vector2((float) Math.cos(theta), (float) Math.sin(theta)).scale(length);
	}
